...
public class Aluguel
{
    ...
    public void main(String [] args)
    {
        ...
        do{
            ...
            System.out.println("11 - Consultar período restante de aluguel");
    ...
    public void alugarEquipamento(){
        ...
        if (conta != null) {
            ...
            if (conta1 != null) {
                ...
                System.out.println("\fEquipamento nao encontrado");
                }
        } else {
            System.out.println("\fCliente nao encontrado");
        }
    }
