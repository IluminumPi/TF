...
public class CadastroEquipamento
{
        ...
        if (total < contas.length) {
            ...
            for (int i = 0; i < total; i++) {
                if (contas[i].getNúmero() == número) {
                    System.out.println("\fErro: Já existe um equipamento com esse número.");
                    return;
                }
            }
    ...
    public void removerEquipamento(){
        ...
        if(removerDoVetor(nome)){
            ...
            System.out.print("\fERRO AO EFETUAR EXCLUSÃO: VERIFIQUE SE O NOME DO EQUIPAMENTO INFORMADO ENCONTRA-SE CADASTRADO\n");           
        }
    }
